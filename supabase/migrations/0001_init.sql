-- Copia exacta de database/schema.sql, como migración de Supabase CLI.
-- Si editas el esquema, edita database/schema.sql (fuente de verdad) y copia
-- el resultado aquí, o crea una migración nueva con `supabase migration new`.
--
